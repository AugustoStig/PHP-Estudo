...
echo '<strong>Impressão da variável "Value" :</strong>'."<br>\n";
...
echo '<strong>Impressão do "var_dump" da variável "Value" :</strong>'."<br>\n";
...
// echo = Use for print messages and variable values;
...
// <br> = Used to break line in the final exibition of the code, must be used into quotation marks, single or double;
